...
--
-- Host: localhost    Database: zabbix_proxy
-- ------------------------------------------------------
...
CREATE TABLE `acknowledges` (
  ...
  `message` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `auditlog` (
  ...
  `note` varchar(128) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `config` (
  ...
  `compress_older` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '7d',
  `instanceid` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_auth_enabled` int NOT NULL DEFAULT '0',
  `saml_idp_entityid` varchar(1024) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_sso_url` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_slo_url` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_username_attribute` varchar(128) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_sp_entityid` varchar(1024) COLLATE utf8_bin NOT NULL DEFAULT '',
  `saml_nameid_format` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  `default_lang` varchar(5) COLLATE utf8_bin NOT NULL DEFAULT 'en_GB',
  `default_timezone` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT 'system',
  `login_attempts` int NOT NULL DEFAULT '5',
  `login_block` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '30s',
  `show_technical_errors` int NOT NULL DEFAULT '0',
  `validate_uri_schemes` int NOT NULL DEFAULT '1',
  `uri_valid_schemes` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT 'http,https,ftp,file,mailto,tel,ssh',
  `x_frame_options` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT 'SAMEORIGIN',
  `iframe_sandboxing_enabled` int NOT NULL DEFAULT '1',
  `iframe_sandboxing_exceptions` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `max_overview_table_size` int NOT NULL DEFAULT '50',
  `history_period` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '24h',
  `period_default` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '1h',
  `max_period` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '2y',
  `socket_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '3s',
  `connect_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '3s',
  `media_type_test_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '65s',
  `script_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '60s',
  `item_test_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '60s',
  `session_key` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '',
  `url` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `report_test_timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '60s',
  `dbversion_status` varchar(1024) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `globalmacro` (
  ...
  `value` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  `description` text COLLATE utf8_bin NOT NULL,
  `type` int NOT NULL DEFAULT '0',
...
CREATE TABLE `host_inventory` (
  ...
  `os` varchar(128) COLLATE utf8_bin NOT NULL DEFAULT '',
  `os_full` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `os_short` varchar(128) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `interface_snmp` (
  ...
  `community` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `securityname` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `securitylevel` int NOT NULL DEFAULT '0',
  `authpassphrase` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `privpassphrase` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `authprotocol` int NOT NULL DEFAULT '0',
  `privprotocol` int NOT NULL DEFAULT '0',
  `contextname` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`interfaceid`),
...
CREATE TABLE `item_tag` (
  ...
  CONSTRAINT `c_item_tag_1` FOREIGN KEY (`itemid`) REFERENCES `items` (`itemid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `media_type` (
  ...
  `timeout` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '30s',
  `process_tags` int NOT NULL DEFAULT '0',
  `show_event_menu` int NOT NULL DEFAULT '0',
  `event_menu_url` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  `event_menu_name` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `description` text COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `module` (
  ...
  `relative_path` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
  `status` int NOT NULL DEFAULT '0',
...
CREATE TABLE `profiles` (
  ...
  `value_str` text COLLATE utf8_bin NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=62103 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44371131 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `report` (
  ...
  `info` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE `scripts` (
  ...
  `publickey` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `privatekey` varchar(64) COLLATE utf8_bin NOT NULL DEFAULT '',
  `menu_path` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '',
...
-- Dump completed on 2022-05-09 12:18:26
